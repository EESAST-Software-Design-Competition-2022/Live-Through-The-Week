...
public class MyCabDoor : MonoBehaviour
{
    // Start is called before the first frame update
    void Start()
    {
        this.GetComponent<Rigidbody>().centerOfMass = transform.GetChild(0).localPosition;
    }
    ...
    public void open()
    {
        ...
        HingeJoint joint = transform.GetComponent<HingeJoint>();
